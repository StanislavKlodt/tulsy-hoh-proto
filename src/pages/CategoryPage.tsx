...
const categoryDescriptions: Record<string, string> = {
  ...
  stoly: 'Столы для заведений любого формата — от уютного кафе до банкетного зала',
...
const faqItems = [
  ...
  { q: 'Какие ткани доступны?', a: 'Более 300 вариантов тканей: велюр, рогожка, эко-кожа, натуральная кожа.' },
