...
const reviews = [
  { id: 1, author: 'Алексей К.', date: '15 января 2025', platform: 'yandex' as const, rating: 5, text: 'Отличное качество мебели и оперативная доставка. Полностью укомплектовали заведение за 2 недели. Рекомендую всем, кто ищет надёжного поставщика.', hasMore: true },
