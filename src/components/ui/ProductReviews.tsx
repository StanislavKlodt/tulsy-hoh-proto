...
const productReviews: Review[] = [
  ...
  },
  {
    ...
    date: '2 июня 2024',
    rating: 5,
    text: 'Покупали угловой диван для гостиной. Качество обивки превосходное, каркас крепкий. Доставили точно в срок, ребята аккуратно занесли на этаж. Очень рекомендую!',
  ...
  },
  {
    ...
    date: '5 апреля 2024',
    rating: 5,
    text: 'Брали мебель для бара — 8 диванов и 12 стульев. Всё сделали за 2 недели. Качество отменное, гости постоянно хвалят. Будем заказывать ещё!',
  ...
  },
  {
    ...
    date: '22 марта 2024',
    rating: 4,
    text: 'Диван красивый и удобный. Немного задержали доставку на пару дней, но менеджер предупредил заранее. В целом довольна покупкой.',
  },
];
